            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea value="{{ old('description') }}" name="description" id="description" class="form-control
                        @error('description')
                            is-invalid
                        @enderror"></textarea>
                        @error('description')
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('nominal') }}" type="number" inputmode="numeric" name="nominal" id="nominal" class="form-control
                        @error('nominal')
                            is-invalid
                        @enderror">
                        @error('nominal')
