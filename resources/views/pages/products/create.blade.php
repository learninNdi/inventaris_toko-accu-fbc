            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('price') }}" type="number" inputmode="numeric" name="price" id="price" class="form-control
                        @error('price')
                            is-invalid
                        @enderror">
                        @error('price')
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('stock') }}" type="number" inputmode="numeric" name="stock" id="stock" class="form-control
                        @error('stock')
                            is-invalid
                        @enderror">
                        @error('stock')
